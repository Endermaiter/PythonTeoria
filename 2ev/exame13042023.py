...
class Exame(Gtk.Window):
    def __init__(self):
        ...
        self.elemento = list()
        for nome in lPerfis:
            self.elemento.append(nome)


        self.entry1.set_text(self.elemento[0][0])
        self.entry2.set_text(self.elemento[1][0])
        self.entry3.set_text(self.elemento[2][0])
        self.entry4.set_text(self.elemento[3][0])
